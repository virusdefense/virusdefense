namespace Utils.Settings
{
    ...
    {
        public const string GROUND_TOWER_LEVEL = "GROUND_TOWER_LEVEL";
        public const string LIGHT_TOWER_LEVEL = "LIGHT_TOWER_LEVEL";
        public const string HEAVY_TOWER_LEVEL = "HEAVY_TOWER_LEVEL";
